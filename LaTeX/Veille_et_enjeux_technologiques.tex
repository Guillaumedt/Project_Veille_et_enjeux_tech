...
\PARstart{L}{es} algorithmes découverts lors de cette analyse d’articles scientifiques répondent bien à notre problématique d’évaluation de la qualité d’images sans référence en apportant un plus par rapport à leur état de l’art. Cependant, ces algorithmes ne sont pas parfaits et présentent des possibilités d’amélioration notables.  
